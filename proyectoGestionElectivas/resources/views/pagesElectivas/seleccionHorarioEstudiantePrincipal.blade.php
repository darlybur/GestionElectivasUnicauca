...
<form class = "form-horizontal" method="POST" action="{{ url('/horario/registrarHorarioEstudiante') }}">
    ...
    <div class="grid-dia"><H1> 7 am - 9 am</H1></div>
        @if(!in_array("L-7-9", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("M-7-9", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("MI-7-9", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("J-7-9", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("V-7-9", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("S-7-9", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("L-9-11", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("M-9-11", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("MI-9-11", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("J-9-11", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("V-9-11", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("S-9-11", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("L-11-1", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("M-11-1", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("MI-11-1", $arrayHorariosDisponiblesDocente))
        ...
        @endif
        @if(!in_array("J-11-1", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("V-11-1", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("S-11-1", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("L-2-4", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("M-2-4", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("MI-2-4", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("J-2-4", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("V-2-4", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("S-2-4", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("L-4-6", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("M-4-6", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("MI-4-6", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("J-4-6", $arrayHorariosDisponiblesDocente))
        <div class="grid-item-inactivo"><input type="checkbox" id='Inactivocheckbox' disable value="J-4-6" name ='models[]'></div>
        @else
        <div class="grid-item"><input type="checkbox" id='checkbox' disable value="J-4-6" name ='models[]'></div>
        @endif


        @if(!in_array("V-4-6", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("S-4-6", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("L-6-8", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("M-6-8", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("MI-6-8", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("J-6-8", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("V-6-8", $arrayHorariosDisponiblesDocente))
        ...
        @if(!in_array("S-6-8", $arrayHorariosDisponiblesDocente))
